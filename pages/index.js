  ...
  return (
    <div className={darkMode ? "dark" : ""}>
      ...
      <main className="w-screen h-screen bg-white dark:bg-gray-800">
        ...
        <section className="pt-4 bg-white dark:bg-gray-800 font-courier">
          <div className="flex justify-center">
            <Link
              className="px-4 py-2 text-white rounded-md hover:bg-slate-700 font-courier bg-slate-500 dark:bg-slate-900 dark:hover:bg-slate-600"
              href="projects"
            >
